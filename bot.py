    ...
    async def my_background_task(self):
        ...
        while not self.is_closed():
            ...
            await channel.send('```[백화난만 채팅공지사항]\n'
                               ...
                               '해당 공지사항은 약 한시간에 한번씩 출력됩니다.\n\n'
                               '건의사항 및 불편사항은 족장에게 쿼리주세요\n\n'
...
async def on_message(message):
    ...
    if message.author == client.user:
        ...
        await client.get_channel(int(channel)).send("```레이드는 일주일에 계정마다 20(15회기본 5회 구입)회 진행 가능하며, 매주 일요일 0시에 초기화됩니다.\n"
                                                    "레이드 클리시에 보스마다 전리품을 각 플레이어에게 지급해줍니다. 여기서 기본으로 1 레이드포인트가 뜨고, 레어템은 각 전리품마다 낮은 확률로 뜰수가 "
                                                    "있습니다.\n\n레이드의 종류\n[마을 레이드]\n[얼음성 레이드]\n[기계무덤 레이드]\n[용 소탕 레이드]\n[칠흑의 정령 레이드]\n[지옥문 레이드] ```",
                                                    delete_after=180.0)
        await asyncio.sleep(5)
        await message.delete()
        ...
        await client.get_channel(int(channel)).send("```※ 본문은 완캐 위주로 설명이 되어있으며, 파티 마다 요구 스펙이 다를 수 있습니다.(활팟기준)\n\n"
                                                    ...
                                                    "중순 : [체력] 최소 900 ↑ [탑순] 260 [주술1] 은혜의정령 Lv.6 [주술2] 수속성 우대\n"
                                                    "고순 : [체력] 최소 900 ↑ [탑순] 390  ↑ [주술1] 은혜의정령 Lv.6 [주술2] 수속성 우대\n"
                                                    "페트 : [수속성] Lv.130 ↑\n\n"
                                                    "AI\n"
                                                    "원숭이(드리오쿠스) : [화우대 사용]\n\n"
                                                    "공략방법\n"
        ...
        await client.get_channel(int(channel)).send(
            ...
            "중순 : [체력] 900 ↑ [탑순] 120 [주술1] 水속성 우대\n"
            "고순 : [체력] 900 ↑ [탑순] 360 [주술1] Lv.6 은혜의정령 [주술2] 오로라의 정령\n"
            "페트 : [수속성] Lv.130 ↑\n\n"
            "공략방법 [첫턴]\n"
            "탑창완캐1 : [위 닉스 - 무지개사용]\n"
            "탑창완캐2 : [아래 닉스 - 무지개사용]\n"
        ...
        await client.get_channel(int(channel)).send("```사전 필수 퀘스트 : 에레보스 진입 퀘스트\n\n"
                                                    ...
                                                    "레이드 인원 : [탱캐릭 1명/ 완캐 3명 / 순캐 1명]\n\n"
                                                    "레이드 스팩\n"
                                                    "탱캐릭 : [체력] 700 ↑ [찍완이 가장 높은 캐릭터] 혼란목걸이 필수\n"
                                                    "완캐 : [체력] 700 ↑ [찍완 500이 ↑] 무지개 2명 / 스테이크, 수우대 1명 (찍완 낮은 캐릭)\n"
                                                    "고순 : [체력] 700 ↑ [탑순 420] [주술1] 은혜의정령 Lv.6 [주술2] 지속성, 수속성 우대\n"
                                                    "페트 : [지속성, 수속성] Lv.130이상\n\n"
                                                    "-지옥문2 AI-\n"
                                                    "헬 바이론 : [마비공격] [낙마술]\n"
                                                    "다크론(앞줄) : [혼란공격] [마비공격]\n"
                                                    ...
                                                    "공략방법\n"
                                                    "1턴\n"
                                                    "탱캐릭(찍완이 가장 높은 캐릭) : 갈푸스가 죽을 때까지 가드\n"
                                                    "완캐 2명 : 델푸스, 울푸스 무지개\n"
                                                    "완캐 1명 :　스테이크 사용\n"
                                                    "고순 : 수우대\n"
                                                    "페트 : 리더, 고순 – 헬베로스 배수의진 / 완캐 3명 – 충견진돗개\n\n"
                                                    "2턴\n"
                                                    "탱캐릭(찍완이 가장 높은 캐릭) : 갈푸스가 죽을 때까지 가드 이후 충견 활공격\n"
                                                    "완캐 2명 : 볼프, 가이록스 무지개\n"
                                                    "완캐 1명 :　활공격\n"
                                                    "고순 : 힐\n"
                                                    "페트 : 리더, 고순, 활공격 완캐 – 헬베로스 배수의진 / 무지개 완캐 2명 – 충견진돗개\n\n"
                                                    "3턴\n"
                                                    "(찍완이 가장 높은 캐릭) : 갈푸스가 죽을 때까지 가드 이후 충견 활공격\n"
                                                    "완캐 : 활공격\n"
                                                    "고순 : 힐\n"
