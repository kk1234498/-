...
"[순캐] - 우대, 힐반복 / 페트 배진 @우대안끊어지도록 주의```")
        ...
        await message.channel.send("```※ 본문은 완캐 위주로 설명이 되어있으며, 파티 마다 요구 스펙이 다를 수 있습니다.(활팟기준)\n\n"
                                   ...
                                   "중순 : [체력] 최소 650 ↑ [탑순] 220 ~ 245사이 [주술1] 은혜의정령 Lv.6 [주술2] 수속성 우대\n"
       ...
       await message.channel.send("```보상 : [정령의 상자 (속성반지 4가지중 하나)] [보석 상자 (중급 스텟초기화 보석)] [경험치 티켓 (80만 경험치)] [흑귀 페트병] "
        ...
        await message.channel.send("```러시안 페트푸드2 : 큰고기(고기3) + 물고기2 + 도토리3 + 해초4```")
...
#페트부분
    elif message.content == ("!성호"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승가능\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 - 10 [2.06]\n"
                                                         "방어력 -  6 [1.24]\n"
                                                         "순발력 -  8 [1.59]\n"
                                                         ...
                                                         "명중수치 - 15%\n\n"
                                                         "획득경로 \n"
                                                         "쟈루 섬 (동442 남634) 포획 [희귀]",
                                  color=0xDF01D7)
        await message.channel.send(embed=embed)
    elif message.content == ("!모사크"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 - 11 [2.34]\n"
                                                         "방어력 -  7 [1.49]\n"
                                                         "순발력 -  5 [1.12]\n"
        ...
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         ...
                                                         "크리수치 - 15%\n\n"
                                                         "획득경로 \n"
                                                         "쿠오해저터널 1층 [쟈루] (동11 남31)포획",
                              color=0xDF01D7)
        await message.channel.send(embed=embed)
    elif message.content == ("!베르푸스"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승가능\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 -  9 [2.05]\n"
                                                         "방어력 -  6 [1.28]\n"
                                                         ...
                                                         "회피수치 -  5%\n\n"
                                                         "획득경로 \n"
                                                         "페트 병(개인 듀얼) 랜덤 보상 - 토라 진화",
                              color=0xDF01D7)
        await message.channel.send(embed=embed)
    elif message.content == ("!토라"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 -  9 [1.94]\n"
                                                         "방어력 -  6 [1.26]\n"
        ...
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         ...
                                                         "명중수치 - 15%\n\n"
                                                         "획득경로 \n"
                                                         "노르노르 Lv.120이상 진화의열매 사용",
                              color=0xDF01D7)
        await message.channel.send(embed=embed)
    elif message.content == ("!두리"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 -  6 [1.90]\n"
                                                         "방어력 -  4 [1.28]\n"
        ...
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승가능\n"
                                                         ...
                                                         "회피수치 -  5%\n\n"
                                                         "획득경로 \n"
                                                         "은빛 보물상자 랜덤 획득 - 페르페 진화",
                              color=0xDF01D7)
        await message.channel.send(embed=embed)
    elif message.content == ("!페르페"):
        embed = discord.Embed(title="페트 정보", description="탑승여부 - 탑승불가\n"
                                                         "판매등급 - 일반\n"
                                                         "공격력 -  9 [1.95]\n"
                                                         "방어력 -  5 [1.26]\n"
